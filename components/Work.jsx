    ...
    return (
        <motion.div
            ...
            <motion.p
                ...
                className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>Welcome to my web development portfolio. Explore the collection of Projects showcasing my knowledge in front-end development.</motion.p>
            <motion.div
                initial={{ opacity: 0 }}
                whileInView={{ opacity: 1 }}
                    ...
                    <motion.div
                        ...
                        <div className='bg-white w-10/12 rounded-md absolute bottom-5 left-1/2 -translate-x-1/2 py-3 px-5 items-center justify-between duration-500 group-hover:bottom-7'>
                            ...
                            <div className='border rounded-full border-black w-9 aspect-square flex items-center justify-center shadow-[2px_2px_0_#000] group-hover:bg-lime-300 transition'>
                                <a href='https://github.com/ruchi-singh0509?tab=repositories'
                                    target='_blank'
